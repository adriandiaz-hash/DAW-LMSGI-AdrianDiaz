...
INSERT INTO empleats_xml (id, dades_xml) VALUES (1, '
...
');
SELECT * FROM empleats_xml;
SELECT ExtractValue(dades_xml, '//employee[jobTitle="VP Sales"]/email') AS Correus_VPSales FROM empleats_xml;
SELECT ExtractValue(dades_xml, 'count(//employee[office/Territory="EMEA"])') AS Empleats_EMEA FROM empleats_xml;
SELECT ExtractValue(dades_xml, '//employee[reportsTo="1056"]/lastName') AS Cognoms_Subordinats FROM empleats_xml;
SELECT ExtractValue(dades_xml, '//employee[@employeeNumber="1166"]/office/City') AS Ciutat_1166 FROM empleats_xml;